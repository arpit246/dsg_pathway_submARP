...
def refresh():
    ...
    data = os.listdir(r"/home/greninja07/Downloads/Sustainable_travel_app/Sustainable_travel_app_main/ui/data")
    return data
...
# React to user input
if prompt := st.chat_input("Describe your travel plans or sustainability concerns:"):
